...
<head>
  ...
  <title>Márcio DUtra Enterprise - Imóveis</title>
...
<!-- Bootstrap core JavaScript -->
  ...
  <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" style="color: #15a97d;"href="#page-top">Márcio Dutra Enterprise</a>
...
<form action="agendamentologado.php" method="post" style="margin-top: 150px">
...
<hr class="star-dark mb-5">
  <div class="form-group ">
    ...
    <label for="exampleInputEmail1">Nome do cliente: <?php echo "$row[0]"; ?></label>
  </div>
  <div class="form-group ">
...
<br>
<p class="my-3">Após clicar em agendar, será gerado um codigo para você, obrigado!</p>
</form>
<br>
...
<footer class="footer text-center">
    <div class="container">
      <div class="row">
        <div class="col-md-4 mb-5 mb-lg-0">
          ...
          <p class="lead mb-0">Avenida Nonoai, 342
            <br>Porto Alegre, RS</p>
        </div>
        <div class="col-md-4 mb-5 mb-lg-0">
          <h4 class="text-uppercase mb-4">Midias Sociais</h4>
          <ul class="list-inline mb-0">
            <li class="list-inline-item">
              <a class="btn btn-outline-light btn-social text-center rounded-circle" href="http://http://marciodutra.rf.gd/" target="_blank">
        ...
        <div class="col-md-4">
          <h4 class="text-uppercase mb-4">Site feito por:</h4>
            <a href="https://github.com/marciodutra?tab=repositories" target="_blank">Márcio Dutra</a><br>            
        </div>
      </div>
    </div>
  </footer>
  ...
  <div class="copyright py-4 text-center text-white">
    <div class="container">
      <small>Copyright &copy; Márcio Dutra Enterprise 2019</small>
    </div>
  </div>
