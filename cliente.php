      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item mx-0 mx-lg-1">
            ...
            <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="cliente.php"><?php include "valida.php"; echo"Área do(a) $row[0]";?></a>
          </li>
        </ul>
      </div>
    </div>
...
<div class="container my-5">
  <div class="alert alert-primary my-5" role="alert">
    ...
    echo "<div class='text-center'>Olá, $row[0] o que deseja?</div>";
...
<div class="container mb-4">
  <div class="row">
    <div class="col-sm">
  <a type="button" class="btn btn-danger" href='logout.php'>Sair da conta</a>
    </div>
    <div class="col-sm-2">
  <a type="button" class="btn btn-primary" href='usuario.php'>Ver imóveis</a>
    </div>
  </div>
</div>
