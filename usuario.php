...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" style="color: #15a97d;"href="usuario.php">Márcio Dutra Enterprise</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item mx-0 mx-lg-1">
            ...
            <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" id="user" href="cliente.php"><?php echo"Área do(a) $row[0]";?></a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 ml-auto">
          <p class="lead">Nós somos uma empresa fictícia de vendas de imóveis feita para um projeto da disciplina Programação Web II, do curso de Análise e Desenvolvimento de Sistemas.</p>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <h4 class="text-uppercase mb-4">Site feito por:</h4>
            <a href="" target="_blank">Márcio Dutra</a><br>           
        </div>
      </div>
    </div>
  </footer>
