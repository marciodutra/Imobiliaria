...
<h2 class="text-center text-uppercase text-secondary">Nós da Márcio Dutra Enterprises agradecemos pela sua preferência, o corretor Marcos estará te esperando até lá! </h2> 
  </div>
</form>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 mb-5 mb-lg-0">
          ...
          <p class="lead mb-0">Avenida Érico Veríssimo 1350
        ...
        <div class="col-md-4">
          <h4 class="text-uppercase mb-4">Site feito por:</h4>
            <a href="https://http://marciodutra.rf.gd/" target="_blank">Márcio Dutra</a><br>
